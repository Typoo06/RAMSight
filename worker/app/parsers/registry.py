...
PARSER_REGISTRY = {
    ...
    "windows.vadinfo": parse_memory_region_artifacts,
    "windows.vadwalk": parse_memory_region_artifacts,
    "windows.ldrmodules": parse_module_artifacts,
    "windows.hollowprocesses": parse_process_artifacts,
    "windows.psxview": parse_process_artifacts,
    "windows.pebmasquerade": parse_process_artifacts,
    "windows.processghosting": parse_process_artifacts,
    "windows.modules": parse_module_artifacts,
    "windows.modscan": parse_module_artifacts,
    "windows.driverscan": parse_module_artifacts,
    "windows.unloadedmodules": parse_module_artifacts,
    "windows.cmdscan": parse_command_artifacts,
    "windows.consoles": parse_command_artifacts,
